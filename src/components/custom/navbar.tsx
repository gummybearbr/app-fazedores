...
import { Home, BookOpen, CheckSquare, BarChart3, Users, Menu } from 'lucide-react';
...
export default function Navbar() {
  ...
  const navItems = [
    ...
    { href: '/trilha', icon: BookOpen, label: 'Trilha' },
    { href: '/tarefas', icon: CheckSquare, label: 'Tarefas' },
    { href: '#', icon: BarChart3, label: 'Indicadores' },
    { href: '#', icon: Users, label: 'Comunidade' },
  ];
